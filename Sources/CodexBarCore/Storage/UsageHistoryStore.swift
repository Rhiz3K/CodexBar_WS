...
// MARK: - CLI Payload Types (for parsing CodexBarCLI JSON output)
...
public struct CLIIdentity: Codable, Sendable {
    ...
    public init(providerID: String? = nil, accountEmail: String? = nil, accountOrganization: String? = nil, loginMethod: String? = nil) {
...
public struct CostHistoryRecord: Codable, Sendable {
    ...
    /// Parse modelsUsed JSON string into array
