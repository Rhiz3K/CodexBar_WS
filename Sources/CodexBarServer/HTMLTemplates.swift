        ...
        return """
            ...
            <body>
                <div class="container">
                    ...
                    <footer class="footer">
                        <div></div>
                        <div class="footer-center">CodexBar Server v0.1.0 · Last update: <span id="last-update" data-timestamp="\(ISO8601DateFormatter().string(from: Date()))">\(Self.formatDate(Date()))</span></div>
